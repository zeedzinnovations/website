...
function Chooseus() {
  return (
    <div className="overflow-x-hidden w-full">   {/* FIX ADDED HERE */}
        ...
        <div className="relative mt-20">
          ...
          <div className="relative z-20 flex flex-col md:flex-row md:flex-wrap justify-center items-center gap-12 xl:flex-nowrap ">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: false, amount: 0.2 }}
              className="relative z-20 w-[316px] h-[431px] bg-[#002762] text-white rounded-[30px] flex flex-col items-center mt-20 md:mt-10 lg:mt-0"
            >
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
              className="relative z-20 w-[316px] h-[431px] bg-[#1B2637] text-white rounded-[30px] flex flex-col items-center pt-10 mt-20 md:mt-10 lg:-mt-10"
            >
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
              className="relative z-20 w-[316px] h-[431px] bg-[#0A3131] text-white rounded-[30px] flex flex-col items-center mt-20 md:mt-10 lg:mt-0"
            >
              <div className="w-14 h-14 mt-[37.8px] rounded-full bg-[#CEE9E9] border-2 border-white flex items-center justify-center">
                <img src={Tick} alt="" className="w-8 h-8" />
              </div>

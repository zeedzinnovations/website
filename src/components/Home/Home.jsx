...
function Home() {
  return (
    <>
      {/* Home Section */}
      <div
        className="bg-[#020101] pt-24 pb-16 
        px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32
        flex flex-col lg:flex-row items-center 
        gap-6 lg:gap-24 overflow-x-hidden"
      >
        {/* LEFT */}
        <motion.div
          variants={fadeInLeft}
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-white w-full lg:w-1/2 flex flex-col gap-4 text-center lg:text-left overflow-x-hidden"
        >
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 sm:gap-10 mt-6">
            <motion.div variants={fadeInUp} className="flex items-center gap-3">
              <img
                src={Project}
                loading="lazy"
                className="w-12 sm:w-16 md:w-20 rounded-2xl"
              />
              <div>
                <p className="text-[#05B8FF] text-[clamp(24px,4vw,35px)] font-semibold">
                  100+
                </p>
        ...
        <motion.img
          ...
          src={Mainhome}
          loading="lazy"
          className="w-full max-w-[350px] sm:w-[70%] md:w-[55%] lg:w-[48%] xl:w-[40%] rounded-[20px] overflow-x-hidden"
        />
      </div>
      ...
      <div
        ...
        px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32
        mt-16 mb-20 items-center lg:items-start 
        text-center lg:text-left overflow-x-hidden"
      >
        <motion.img
          variants={fadeInLeft}
          initial="hidden"
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="w-full lg:w-1/2 flex flex-col gap-4 overflow-x-hidden"
        >
          ...
          >
            <Link to="/about">
              <button className="bg-[#1D1D1D] text-white rounded-full w-40 sm:w-[170px] h-[45px] sm:h-[49px] lg:w-[200px] flex items-center justify-between px-4">
                <span className="text-[clamp(14px,2vw,18px)] font-medium">
                  READ MORE
                </span>
